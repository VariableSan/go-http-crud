...
import (
	...
	"github.com/VariableSan/go-http-crud/internal/utils"
...
func New(workoutStore store.WorkoutStore, logger *log.Logger) *WorkoutHandler {
...
func (wh *WorkoutHandler) HandleUpdateWorkoutByID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		wh.logger.Printf("ERROR: getWorkoutByID: %v", err)
		utils.WriteJSON(w, http.StatusInternalServerError, utils.Envelope{"error": "interval server error"})
		return
	}
